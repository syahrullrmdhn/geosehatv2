...
<div class="w-full max-w-xl mx-auto py-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-semibold">Tambah Wilayah Baru</h2>
    ...
    <form action="{{ route('regions.store') }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="4"
                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:border-indigo-500">{{ old('description') }}</textarea>
        </div>
